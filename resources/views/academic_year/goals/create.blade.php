        ...
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                <div class="section-block">
                    ...
                    <form action="{{ route('academic_years.goals.store', $academicYear) }}" method="post">
                    {{ csrf_field() }}

                        <div class="form-group{{ $errors->has('description') ? ' has-error' : '' }}">
                            <label class="control-label">Doel beschrijving <span class="text-primary">*</span></label>
                            <input type="text" name="description" class="form-control input-sm" value="{{ old('description') }}" required/>
                        ...
                        <div class="form-group{{ $errors->has('amount') ? ' has-error' : '' }}">
                            ...
                            <div class="input-group">
                                ...
                                <input id="amount" type="text"  class="form-control input-sm" name="amount" value="{{ old('amount', '5,00') }}" required/>
                            </div>
